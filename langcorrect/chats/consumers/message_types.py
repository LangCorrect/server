...
class OutgoingEventStoppedTyping(NamedTuple):
    ...
    def to_json(self) -> str:
        return json.dumps({"msg_type": MessageTypes.TypingStopped, "user_pk": self.user_pk})
...
class OutgoingEventWentOnline(NamedTuple):
    ...
    def to_json(self) -> str:
        return json.dumps({"msg_type": MessageTypes.WentOnline, "user_pk": self.user_pk})
...
class OutgoingEventWentOffline(NamedTuple):
    ...
    def to_json(self) -> str:
        return json.dumps({"msg_type": MessageTypes.WentOffline, "user_pk": self.user_pk})
